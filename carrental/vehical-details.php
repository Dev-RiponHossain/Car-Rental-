...
$sql="INSERT INTO tblbooking (BookingNumber, userEmail, VehicleId, FromDate, ToDate, message, Status, division_name, district_name, address) 
VALUES (:bookingno, :useremail, :vhid, :fromdate, :todate, :message, :status, :division_name, :district_name, :address)";
...
$query->bindParam(':division_name',$division_name,PDO::PARAM_STR);
$query->bindParam(':district_name',$district_name,PDO::PARAM_STR);
...
document.addEventListener("DOMContentLoaded", function () {
    const vhid = <?= json_encode($_GET['vhid']) ?>;

    $.ajax({
        url: 'get-booked-dates.php',
        type: 'POST',
        data: { vhid: vhid },
        dataType: 'json',
...
<?php }} ?>
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="division" name="division_name" required>
      <option value="">Select Division</option>
      <?php
        $sql = "SELECT * FROM divisions";
        $query = $dbh->prepare($sql);
        $query->execute();
        $divisions = $query->fetchAll(PDO::FETCH_OBJ);
        foreach($divisions as $div){
          echo "<option value=\"{$div->name}\">{$div->name}</option>";
        }
      ?>
    </select>
  </div>
  ...
  <div class="form-group">
    <label>Address:</label>
    <textarea rows="4" class="form-control" name="address" placeholder="Enter your address" required></textarea>
  </div>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">tk <?php echo htmlentities($result->PricePerDay);?></p>
